        ...
        <div class="flex items-center justify-between">
            ...
            <div id="dl-menu" class="dl-menuwrapper">
                ...
                <ul class="dl-menu">
                    ...
                    <li>
                        <a href="portfolio-webDevelopment.php">Portfolio</a>
                        <ul class="dl-submenu">
                            <li>
                                <a href="#">Web Development</a>
                                <ul class="dl-submenu">
                                    <li>
                                        <a href="portfolio-webProjectAround.php">Around The World</a>
                                    </li>
                                    <li>
                                        <a href="portfolio-homeland.php">Homeland</a>
                                    </li>
                                </ul>
                            </li>
                            </ul>
            ...
            <div class="w-[195px] md:w-[280px] sm:w-[200px] col:w-[50px]">
                <a class="text-[45px] col:text-[25px] font-bold flex items-center text-white" href="index.php">
                    <img
            ...
            <a
                ...
                download="Dēivid Sans' Resume"
                href="assets/images/Dēivid_Sans_Resume.jpg"
            >
                <img
